    ...
    <div>
      ...
      <section className="relative py-24 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p
            className="text-xl text-primary-100 animate-fade-in-up"
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="project-inquiry">Căn đẹp</option>
                        <option value="investment">Pháp lý</option>
                        <option value="partnership">Tiến độ dự án</option>
                        <option value="customer-service">Tài chính</option>
                        <option value="other">Căn giá tốt</option>
                      </select>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-2 text-gray-600">
                  ...
                  <div className="flex justify-between">
                    <span>Thứ 7:</span>
                    <span className="font-medium">8:30 - 12:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Chủ nhật:</span>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Số 2, ngõ 18/61, phố Định Công Thượng, Phường Định Công, Quận
          ...
          <div className="rounded-2xl overflow-hidden h-96">
                  <iframe
                    title="Google Map"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.456924708243!2d105.83021981540243!3d20.97976108602757!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135adc4cfc22b03%3A0x8e3e1cc275a2c8ef!2zMiBOLiAxOC82MSDEkOG7i25oIEPDtG5nIFRow7p5LCBExrDGoW5oIENvbmcsIEhvw6BuZyBNYWksIEjDoCBO4buZaQ!5e0!3m2!1svi!2s!4v1718098765432!5m2!1svi!2s"
                    width="100%"
                    height="100%"
                    allowFullScreen
                    loading="lazy"
